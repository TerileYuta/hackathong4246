...
def get_credentials():
    ...
    credentials_path = os.path.join(script_dir, '..', '..', 'config', 'google_calendar_api', 'credentials.json')
    token_path = os.path.join(script_dir, '..', '..', 'config', 'google_calendar_api', 'token.json')
